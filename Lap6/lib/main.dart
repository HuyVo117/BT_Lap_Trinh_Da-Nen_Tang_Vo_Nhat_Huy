...
import 'widget_custom_button_lap6.dart';
...
class _Lap6State extends State<Lap6> {
  ...
  List<Questionmodal> listQuestion = [
    ...
    Questionmodal(
        question: "Học phân đa nền tảng là học phần 3 tín chỉ", answer: false),
    Questionmodal(
        question: "Học phân đa nền tảng là học phần 2 tín chỉ", answer: true),
    Questionmodal(
        question: "Năm nay VKU kỉ niệm 6 năm thành lập trường",
        answer: false),
    Questionmodal(
        question: "Năm nay VKU kỉ niệm 5 năm thành lập trường",
        answer: true),
  ];
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  WidgetCustomButtonLap6(
                    color: Colors.green,
                    text: "True",
                    handle: () {
                      setState(() {
                        listAnswer
                            .add(answer(true, listQuestion[index]));
                  ...
                  WidgetCustomButtonLap6(
                    ...
                    handle: () {
                      setState(() {
                        listAnswer
                            .add(answer(false, listQuestion[index]));
                        if (index == listQuestion.length - 1) {
                          index = 0;
                        } else {
                          index++;
